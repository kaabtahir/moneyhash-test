...
function getBaseUrl() {
  ...
  if (environment == undefined || environment == null) return 'https://decathlon.moneyhash.io/';
  else if (environment == 'prod') return 'https://decathlon.moneyhash.io/';
  else if (environment == 'local') return 'http://localhost';
  else return 'https://decathlon.moneyhash.io/';
}
